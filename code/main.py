...
def run_dfbnb_snake(heuristic, graph, start, target, weight, cutoff, timeout, is_incremental, n, save_dir):
    print('running dfbnb')
...
#     bcc_dict = {}
    ...
    end_state, data = max_dfbnb_iterative(graph,
                                ...
                                expand=expand_with_snake_constraints,
                                save_dir=save_dir
                                )
...
def run_weighted_snake(heuristic, graph, start, target, weight, cutoff, timeout, is_incremental, n, save_dir):
